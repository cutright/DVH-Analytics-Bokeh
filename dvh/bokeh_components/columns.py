...
selection_filter = [TableColumn(field="row", title="Row", width=60),
...
range_filter = [TableColumn(field="row", title="Row", width=60),
...
dvhs = [TableColumn(field="mrn", title="MRN / Stat", width=175),
...
endpoints = [TableColumn(field="mrn", title="MRN / Stat", width=175),
             TableColumn(field="group", title="Group", width=175),
             TableColumn(field="roi_name", title="ROI Name")]
for i in range(ENDPOINT_COUNT):
    endpoints.append(TableColumn(field="ep%s" % (i+1), title="ep%s" % (i+1), width=80,
                                 formatter=NumberFormatter(format="0.00")))


ep_data = [TableColumn(field="row", title="Row", width=60),
           TableColumn(field="label", title="Endpoint", width=180),
           TableColumn(field="units_out", title="Units", width=60)]


rad_bio = [TableColumn(field="mrn", title="MRN", width=150),
...
emami = [TableColumn(field="roi", title="Structure", width=150),
...
beams = [TableColumn(field="mrn", title="MRN", width=105),
...
beams2 = [TableColumn(field="mrn", title="MRN", width=105),
          TableColumn(field="group", title="Group", width=230),
          TableColumn(field="beam_name", title="Name", width=150),
...
plans = [TableColumn(field="mrn", title="MRN", width=420),
         TableColumn(field="group", title="Group", width=230),
...
rxs = [TableColumn(field="mrn", title="MRN"),
       TableColumn(field="group", title="Group", width=230),
...
corr_chart = [TableColumn(field="stat", title="Single-Var Regression", width=100),
              TableColumn(field="group_1", title="Group 1", width=60),
              TableColumn(field="group_2", title="Group 2", width=60)]


multi_var_include = [TableColumn(field="var_name", title="Variables for Multi-Var Regression", width=100)]

multi_var_model_1 = [TableColumn(field="var_name", title="Independent Variable", width=300),
                     TableColumn(field="coeff_str", title="coefficient",  width=150),
                     TableColumn(field="p_str", title="p-value", width=150)]

multi_var_model_2 = [TableColumn(field="var_name", title="Independent Variable", width=300),
                     TableColumn(field="coeff_str", title="coefficient",  width=150),
                     TableColumn(field="p_str", title="p-value", width=150)]

multi_var_coeff_1 = [TableColumn(field="y_var", title="Dependent Variable", width=150),
                     TableColumn(field="r_sq_str", title="R-squared", width=150),
                     TableColumn(field="model_p_str", title="Prob for F-statistic", width=150)]

multi_var_coeff_2 = [TableColumn(field="y_var", title="Dependent Variable", width=150),
                     TableColumn(field="r_sq_str", title="R-squared", width=150),
                     TableColumn(field="model_p_str", title="Prob for F-statistic", width=150)]


mlc_viewer = [TableColumn(field="cp", title="CP"),
